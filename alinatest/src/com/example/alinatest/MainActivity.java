...
public class MainActivity extends SimpleBaseGameActivity {
	...
	public EngineOptions onCreateEngineOptions() {
		...
		final EngineOptions engineOptions = new EngineOptions(true, ScreenOrientation.LANDSCAPE_SENSOR, new FillResolutionPolicy(), this.mCamera);
//		engineOptions.getTouchOptions().setNeedsMultiTouch(true);
	...
	public Scene onCreateScene() {
		...
		this.mScene.setBackground(new Background(0.09804f, 0.1274f, 0.1784f));
	...
	private void addCard(final Card alinalaimanparekocard, final int pX, final int pY) {
		final Sprite sprite = new Sprite(pX, pY, this.mCardTotextureRegionMap.get(alinalaimanparekocard), this.getVertexBufferObjectManager()) {
